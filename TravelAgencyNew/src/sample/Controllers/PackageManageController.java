    ...
    public class PackageManageController {
        ...
        public void storeFilmInfo(ActionEvent event) throws ParseException {
            ...
            try {
                ...
                Alert alert = new Alert(Alert.AlertType.INFORMATION, "The film " + filmTitle.getText() + " has been added!",
                        ButtonType.OK);
                alert.showAndWait();
                ...
                Alert alert = new Alert(Alert.AlertType.WARNING, "File Not Found!", ButtonType.OK);
                alert.showAndWait();
                if (alert.getResult() == ButtonType.OK) {
                    alert.close();
                }
            } catch (IOException e) {
                Alert alert = new Alert(Alert.AlertType.WARNING, "Error: " + e.getMessage(), ButtonType.OK);
                alert.showAndWait();
                if (alert.getResult() == ButtonType.OK) {
                    alert.close();
                }
